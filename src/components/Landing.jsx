        ...
        <Stack spacing={10} direction='row' className='section-cards'>
          <Card
            ...
            <CardContent className='card1'>
              ...
              <div className='rankomat-text2'>
                <span className='rankomat-text2-0'>1. </span>
                <span className='rankomat-text2-3'>Stwórz ogłoszenie</span>
              </div>
              <div
          ...
          <Card sx={{ minWidth: 275 }} className='card-container'>
            <CardContent className='card1'>
              ...
              <div className='rankomat-text2'>
                <span className='rankomat-text2-0'>2. </span>
                <span className='rankomat-text2-3'>
                  Dopasuj kandydatów
                  <br />
                  do ogłoszenia
                </span>
          ...
          <Card
            ...
            <CardContent className='card1'>
              ...
              <div className='rankomat-text2'>
                <span className='rankomat-text2-0'>3. </span>
                <span className='rankomat-text2-3'>
                  Przygotuj się
                  <br />
                  do rozmowy
